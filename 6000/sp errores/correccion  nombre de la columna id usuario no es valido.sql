...
insert into Usuarios (usuario, Contrasena, LastEditDate, CreationDate,Nombre,Mail,Password,Estatus) 
values('Administrador','DEMO','2010-02-06','2010-02-06', 'Administrador','admin@admin.com',null,1)
SET IDENTITY_INSERT [dbo].[Usuarios] off
end

alter table usuarios add  Nombre varchar(30) null
alter table usuarios add  Mail varchar(30) null
alter table usuarios add  Password [varbinary](500) null
alter table usuarios add  Estatus bit null
